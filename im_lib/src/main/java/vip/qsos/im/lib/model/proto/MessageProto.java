    ...
    public static final class Model extends
        ...
        public static final class Builder extends
                com.google.protobuf.GeneratedMessageLite.Builder<
                        MessageProto.Model, Builder> implements
                // @@protoc_insertion_point(builder_implements:Model)
                MessageProto.ModelOrBuilder {
            // Construct using MessageProto.Model.newBuilder()
            private Builder() {
        ...
        protected final Object dynamicMethod(
            ...
            switch (method) {
                ...
                case VISIT: {
                    ...
                    MessageProto.Model other = (MessageProto.Model) arg1;
                ...
                case GET_PARSER: {
                    if (PARSER == null) {
                        synchronized (MessageProto.Model.class) {
                            if (PARSER == null) {
