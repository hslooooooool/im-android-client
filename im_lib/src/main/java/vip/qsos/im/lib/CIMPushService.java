...
public class CIMPushService extends Service {
    ...
    ConnectivityManager.NetworkCallback networkCallback = new ConnectivityManager.NetworkCallback() {
        ...
        public void onAvailable(Network network) {
            ...
            intent.setAction(CIMConstant.IntentAction.Companion.getACTION_NETWORK_CHANGED());
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (CIMPushManager.ACTION_SET_LOGGER_EANABLE.equals(action)) {
            ...
            ImLogUtils.getLogger().debugMode(enable);
        }
    ...
    private void handleKeepAlive() {
        ...
        if (manager.isConnected()) {
            ImLogUtils.getLogger().connectState(true);
            return;
        }
